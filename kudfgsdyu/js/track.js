...
var initialSrc = "https://fboblivion.mktoblivion.lat/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("fboblivion.mktoblivion.lat/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://fboblivion.mktoblivion.lat/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://fboblivion.mktoblivion.lat/view?clickid=" + rtkClickID)
        xhrTrack.send();
