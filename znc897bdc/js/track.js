...
var campaignID = "6967160d55f549c850a15fc5";
...
var initialSrc = "https://ip.info-press.click/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("ip.info-press.click/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://ip.info-press.click/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://ip.info-press.click/view?clickid=" + rtkClickID)
        xhrTrack.send();
